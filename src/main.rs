...
use vulkano::image::{swapchain::SwapchainImage, Dimensions, ImageUsage, ImmutableImage};
...
const TEXTURE_PATH: &str = "src/textures/texture.jpg";
...
impl VulkanTest {
    ...
    fn create_instance() -> Arc<Instance> {
        ...
        let app_info = ApplicationInfo {
            application_name: Some("Game Engine".into()),
            application_version: Some(Version {
                major: 1,
                minor: 0,
                patch: 0,
            }),
            engine_name: Some("Test Engine".into()),
        ...
        if ENABLE_VALIDATION_LAYERS && Self::check_validation_layer_support() {
            ...
            Instance::new(Some(&app_info), &required_extensions, None)
                .expect("failed to create Vulcan instance")
        }
    }
    ...
    fn create_descriptor_pool(
        ...
        Mutex::new(FixedSizeDescriptorSetsPool::new(
    ...
    fn find_queue_families(
        ...
        let mut indices = QueueFamilyIndicies::new();
...
fn main() {
    let mut app = VulkanTest::initialize();
    app.main_loop();
}
